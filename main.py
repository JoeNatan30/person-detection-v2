...
def main(proceso, tipo):
    ...
    rangeOfDiff = 0.02     # Range of Difference used during normal calculation
    ...
    if proceso == "captura":
        ...
        procesos.procesamiento_real(cant_PCD, porcentaje, tamano_conjunto,
                                    version, max_proces_paral,
                                    pos_proces_paral, rangeOfDiff, verbose)
    elif proceso == "preparacion_dataset":
        procesos.preparacion_dataset(cant_PCD, porcentaje, verbose)
        ...
        print("    ruido-rangeDiffVsPointsAcum")
        print("    ransac-rangeDiff")
